...
Redmine Plugin for importing users from a csv file. Forked from
- https://github.com/shrkw/redmine_user_import
- http://www.redmine.org/plugins/user_import_plugin

and modified to work with recent (3.4) version of Redmine.



== More credits from the original fork
